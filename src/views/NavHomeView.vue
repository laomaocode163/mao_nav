  ...
  <div v-else class="nav-home">
    ...
    <aside class="sidebar">
      ...
      <div class="logo-section">
        ...
        <h1 class="site-title">{{ title || '念铭导航' }}</h1>
      </div>
        ...
        <div v-else class="categories-container">
          ...
          <footer class="page-footer" hidden="true">
            ...
            <div class="footer-bottom">
              <p>&copy; {{ new Date().getFullYear() }} 念铭导航 - 由 <a href="https://github.com/maodeyu180" target="_blank" rel="noopener noreferrer">maodeyu180</a> 用 ❤️ 制作</p>
